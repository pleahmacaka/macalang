...
바인딩합니다. `match`는 **식**이라 화살표 본문 전체가 될 수도, 문장으로 설 수도
있습니다.
...
이진 트리를 만들고, 더하고, 출력합니다. 그다음 안에 있는 `match`에서 갈래 하나를
지우고 다시 빌드해 보세요. 진단 메시지가 빠뜨린 변형의 이름을 알려 줍니다.
