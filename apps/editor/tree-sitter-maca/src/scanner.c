...
static const long long Space = 32;
static const long long Tab = 9;
static const long long Return = 13;
static const long long Feed = 10;
static const long long Newline = 0;
long long ts_look();
long long ts_take();
long long ts_ok(long long sym);
long long ts_emit(long long sym);
long long blank(long long c);
long long continues_line(long long c);
long long scan_newline();
long long blank(long long c) { return ((((c == Space) || (c == Tab)) || (c == Return)) || (c == Feed));  }
long long continues_line(long long c) { return ((((((((((((((((c == 63) || (c == 58)) || (c == 43)) || (c == 45)) || (c == 42)) || (c == 37)) || (c == 60)) || (c == 62)) || (c == 61)) || (c == 38)) || (c == 124)) || (c == 46)) || (c == 41)) || (c == 93)) || (c == 125)) || (c == 44));  }
long long scan_newline() { long long crossed = 0; while (blank(ts_look())) { if ((ts_look() == Feed)) { crossed = 1; crossed; } ts_take(); } if (((!crossed) || (!ts_ok(Newline)))) { return 0; } if (continues_line(ts_look())) { return 0; } ts_emit(Newline); return 1;  }
#include "tree_sitter/parser.h"

static TSLexer *maca_ts_lexer;
static const bool *maca_ts_valid;

long long ts_look(void) { return (long long)maca_ts_lexer->lookahead; }
long long ts_take(void) { maca_ts_lexer->advance(maca_ts_lexer, true); return 0; }
long long ts_ok(long long sym) { return maca_ts_valid[sym] ? 1 : 0; }
long long ts_emit(long long sym) { maca_ts_lexer->result_symbol = (TSSymbol)sym; return 0; }
